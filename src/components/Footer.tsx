      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link to="/listings?city=bangalore" className="hover:text-white transition-colors">Bangalore</Link></li>
              <li><Link to="/listings?city=mumbai" className="hover:text-white transition-colors">Mumbai</Link></li>
              <li><Link to="/listings?city=delhi" className="hover:text-white transition-colors">Delhi</Link></li>
              <li><Link to="/listings?city=hyderabad" className="hover:text-white transition-colors">Hyderabad</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center text-sm">
          <p>© {new Date().getFullYear()} PropertyPrime. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
